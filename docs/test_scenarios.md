...
| **UI 元件測試** | React 元件渲染與互動行為 | Mock API 回應 | Vitest + Testing Library |
...
### 3.3 Transaction 與 Race Condition
...
#### TC-SEC-AUTHZ-002｜直接修改 URL 查看他人預約
...
預期：router.push 呼叫 /my/bookings/:bookingId
```
